...
def load_dataset(prefix=''):
    # load all train
    trainX, trainy = load_dataset_group('train', prefix + '/home/pi/Desktop/UCI HAR Dataset/')
    # load all test
    testX, testy = load_dataset_group('test', prefix + '/home/pi/Desktop/UCI HAR Dataset/')
